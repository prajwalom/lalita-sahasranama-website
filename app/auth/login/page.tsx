      ...
      <Card className="w-full max-w-md bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-rose-200 dark:border-rose-800">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-600 dark:text-gray-400">
            Continue your spiritual journey with the Divine Mother
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/auth/signup" className="text-rose-600 hover:text-rose-700 dark:text-rose-400 dark:hover:text-rose-300 font-medium">
                Sign up
              </Link>
            </p>
          </div>
